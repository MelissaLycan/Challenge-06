...
$(".btn-honolulu").on("click", function() {
    localStorage.clear()
    var title = "Honolulu"
    var queryHonolulu = "https://api.openweathermap.org/geo/1.0/direct?q=honolulu&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-denver").on("click", function() {
    localStorage.clear()
    var title = "Denver"
    var queryDenver = "https://api.openweathermap.org/geo/1.0/direct?q=Denver&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-anchorage").on("click", function() {
    localStorage.clear()
    var title = "Anchorage"
    var queryAnchorage = "https://api.openweathermap.org/geo/1.0/direct?q=Anchorage&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-London").on("click", function() {
    localStorage.clear()
    var title = "London"
    var queryLondon = "https://api.openweathermap.org/geo/1.0/direct?q=london&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-rome").on("click", function() {
    localStorage.clear()
    var title = "Rome"
    var queryRome = "https://api.openweathermap.org/geo/1.0/direct?q=Rome&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-tokyo").on("click", function() {
    localStorage.clear()
    var title = "Tokyo"
    var queryTokyo = "https://api.openweathermap.org/geo/1.0/direct?q=Tokyo&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-tampa").on("click", function() {
    localStorage.clear()
    var title = "Tampa"
    var queryTampa = "https://api.openweathermap.org/geo/1.0/direct?q=Tampa&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
$(".btn-sydney").on("click", function() {
    localStorage.clear()
    var title = "Sydney"
    var querySydney = "https://api.openweathermap.org/geo/1.0/direct?q=sydney&limit=10&appid=f36a53de48bea522c1d962429f2d35bb";
...
function getWeatherAPI() {
    ...
    var urlEnd = '&exclude=minutely,hourly&units=imperial&appid=f36a53de48bea522c1d962429f2d35bb';
    var urlMid = '&lon=';
...
$.ajax({
  ...
  method: 'GET',
    ...
    $("#humidityToday").text("Humidity: " + (localStorage.getItem("humidity", humidity)));
    $("#iconToday").attr("src", iconUrlStart + icon + iconUrlEnd);
    $("#uvIndex").text("UV Index: " + ((localStorage.getItem("UVI", uvi))));

    $("#temp1").text("Temp: " + (localStorage.getItem("temp1", temp1)))
    $("#wind1").text("Wind Speed: " + (localStorage.getItem("wind1", wind1)))
    $("#humidity1").text("Humidity: " + (localStorage.getItem("humidity1", humidity1)))
    ...
    $("#humidity2").text("Humidity: " + (localStorage.getItem("humidity2", humidity2)))
    ...
    $("#humidity3").text("Humidity: " + (localStorage.getItem("humidity3", humidity3)))
    ...
    $("#humidity4").text("Humidity: " + (localStorage.getItem("humidity4", humidity4)))
    ...
    $("#humidity5").text("Humidity: " + (localStorage.getItem("humidity5", humidity5)))
